...
- `audit-psicometrico-2026-08.md` descrive l'audit trasversale e lo stato corrente dei 25 questionari.
...
- `revisione-esempi-item-2026-08.md` documenta l'audit dei 600 item e gli esempi facoltativi aggiunti agli item più astratti.
...
- `test-intelligenza-linguistica-v1.md` è la specifica psicometrica corrente del questionario sull'intelligenza linguistica e documenta la distinzione tra cornice di Gardner, autopercezione e prove di competenza.
