    ...
    <main className="editorial-shell">
      ...
      <section className="editorial-process" aria-labelledby="come-nasce">
        ...
        <ol className="process-grid">
          <li><span>01</span><h3>Consultazione</h3><p>Vengono raccolte fonti istituzionali e pubblicazioni utili a comprendere il tema e i suoi limiti.</p></li>
      ...
      <section className="editorial-principles">
        <article><p className="eyebrow">Selezione delle fonti</p><h2>Riferimenti tracciabili</h2><p>Vengono privilegiate risorse di enti sanitari e istituzionali, linee guida, università e pubblicazioni scientifiche identificabili tramite riviste, DOI, PubMed o PMC. Le fonti sono collegate direttamente per consentire l'approfondimento.</p></article>
        ...
        <article><p className="eyebrow">Limiti</p><h2>Contenuti editoriali</h2><p>Le fonti orientano struttura e linguaggio, ma non costituiscono una validazione psicometrica o una revisione clinica. Questionari e guide non sostituiscono una valutazione individuale.</p></article>
      </section>
