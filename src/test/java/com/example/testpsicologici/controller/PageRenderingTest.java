...
class PageRenderingTest {
    ...
    void methodPageExplainsProcessAndGroupsSourcesByTest() throws Exception {
        mockMvc.perform(get("/metodo-e-fonti"))
                ...
                .andExpect(content().string(containsString("src=\"/images/alessia-liga-revisore-professionale-2.jpg\"")))
    ...
    void emotionalDependenceGuideRendersHelpfulContentSourcesAndBidirectionalLink() throws Exception {
        mockMvc.perform(get("/approfondimenti/dipendenza-affettiva"))
                ...
                .andExpect(content().string(containsString("Dipendenza affettiva")))
                .andExpect(content().string(containsString("class=\"recommended-reading-cover\"")))
                .andExpect(content().string(containsString("recommended-reading-card has-placeholder-cover")))
                .andExpect(content().string(containsString("tag=spaziotest-21")))
                .andExpect(content().string(containsString("rel=\"noopener noreferrer sponsored\"")))
    ...
    @Test
    void emotionalDependenceResultRendersTheSameOptionalAffiliateReadingsAsTheGuide() throws Exception {
        mockMvc.perform(get("/test/dipendenza-affettiva/risultato")
                        .session(completedAttempt("dipendenza-affettiva", 3)))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Letture facoltative")))
                .andExpect(content().string(containsString(
                        "Quaderno di esercizi per vincere la dipendenza affettiva")))
    ...
    @Test
    void generalizedAnxietyResultRendersTheSameOptionalAffiliateReadingsAsTheGuide()
            throws Exception {
        mockMvc.perform(get("/test/ansia-generalizzata/risultato")
                        .session(completedAttempt("ansia-generalizzata", 3)))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Letture facoltative")))
                .andExpect(content().string(containsString(
                        "Quaderno di esercizi per vincere l&#39;ansia generalizzata")))
    ...
    @Test
    void depressedMoodResultRendersTheSameOptionalAffiliateReadingsAsTheGuide()
            throws Exception {
        mockMvc.perform(get("/test/umore-depresso/risultato")
                        .session(completedAttempt("umore-depresso", 3)))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Letture facoltative")))
                .andExpect(content().string(containsString(
                        "Quaderno di esercizi per vincere la depressione")))
    ...
    @Test
    void peoplePleasingResultRendersTheSameOptionalAffiliateReadingsAsTheGuide()
            throws Exception {
        mockMvc.perform(get("/test/people-pleasing/risultato")
                        .session(completedAttempt("people-pleasing", 3)))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Letture facoltative")))
                .andExpect(content().string(containsString(
                        "Quaderno di esercizi per sviluppare l&#39;assertività")))
