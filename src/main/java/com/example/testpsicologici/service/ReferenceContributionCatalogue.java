...
public class ReferenceContributionCatalogue {
    ...
    private static final Map<String, String> CONTRIBUTIONS = Map.ofEntries(
            ...
            entry("https://www.istat.it/statistiche-per-temi/focus/violenza-sulle-donne/il-contesto/definizioni-e-indicatori/",
                    "Fonte istituzionale italiana consultata per denigrazione, controllo, isolamento e intimidazione nella violenza psicologica; il perimetro riguarda soprattutto donne e partner e non definisce una scala sul gaslighting."),
            entry("https://eige.europa.eu/publications-resources/publications/understanding-psychological-violence-against-women-need-harmonised-definitions-and-data-eu",
                    "Sintesi istituzionale europea consultata per collocare il gaslighting nell'abuso emotivo e nel più ampio quadro della violenza psicologica; non è una misura né una valutazione individuale."),
