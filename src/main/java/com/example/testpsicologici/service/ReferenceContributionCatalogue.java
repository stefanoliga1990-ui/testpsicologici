...
public class ReferenceContributionCatalogue {
    ...
    private static final Map<String, String> CONTRIBUTIONS = Map.ofEntries(
            ...
            entry("https://doi.org/10.1037/cfp0000094",
                    "Sviluppo del TRI consultato per distinguere forme di coinvolgimento di una terza persona nei conflitti; riguarda soprattutto triangolazione intergenerazionale retrospettiva e non valida il questionario di coppia dell'app."),
            entry("https://doi.org/10.1007/s12144-012-9144-3",
                    "Studio statunitense consultato per comportamenti e motivazioni riferite di induzione della gelosia; misura chi agisce, usa un campione soprattutto studentesco e non consente di inferire intenzioni del partner."),
            entry("https://doi.org/10.7366/1896180020153306",
                    "Studio polacco consultato come evidenza europea su gelosia e strategie di influenza relazionale; prospettiva di chi agisce, campione circoscritto e disegno correlazionale non validano item o soglie dell'app."),
            entry("https://doi.org/10.1177/0265407518802451",
                    "Studio consultato per associazioni tra induzione della gelosia, variabili relazionali e violenza di coppia; dati trasversali e regionali non dimostrano causalità né permettono valutazioni individuali."),
            ...
            entry("https://www.oecd.org/en/publications/oecd-guidelines-on-measuring-subjective-well-being-2025-update_9203632a-en/full-report/measuring-subjective-well-being_b4b53f27.html",
                    "Linee guida OECD consultate per distinguere valutazione della vita, affetti, eudaimonia e condizioni oggettive; le otto aree, l'uguale ponderazione e la scala 1–5 dell'app restano scelte editoriali non validate."),
            entry("https://www.oecd.org/en/publications/oecd-guidelines-on-measuring-subjective-well-being-2025-update_9203632a-en/full-report/core-and-extended-survey-modules_37f842ef.html",
                    "Modulo OECD consultato per le valutazioni separate di tenore di vita, salute, realizzazione, relazioni, sicurezza, comunità, futuro, tempo, ambiente e lavoro; le domande ufficiali 0–10 non sono copiate o convertite."),
            entry("https://pubmed.ncbi.nlm.nih.gov/10859875/",
                    "Validazione italiana WHOQOL-BREF consultata per la distinzione tra domini fisico, psicologico, sociale e ambientale; qualità di vita, campione sanitario e strumento non validano il profilo di soddisfazione dell'app."),
            ...
            entry("https://doi.org/10.1177/02654075211000417",
                    "Studio qualitativo di ricercatori italiani consultato per definizione dell'orbiting, presenza visibile sui social e reazioni riferite; campione giovane, ricordo retrospettivo e nessuna scala validata."),
            entry("https://doi.org/10.5817/CP2022-2-9",
                    "Studio su giovani adulti soprattutto italiani consultato per distinguere interruzione diretta e presenza social e confrontare orbiting, ghosting e rifiuto; il compito di richiamo non valida item o soglie."),
            entry("https://doi.org/10.1111/pere.12492",
                    "Studio statunitense sul ghosting consultato per cessazione della comunicazione e unfollowing; costrutto, campione soprattutto studentesco e risultati non sono trasferiti al test sull'orbiting."),
            entry("https://pubmed.ncbi.nlm.nih.gov/22946958/",
                    "Studio britannico consultato per il contesto dell'osservazione social dopo una rottura; misura chi osserva l'ex, non chi riceve la presenza digitale, e l'associazione non dimostra causalità."),
            entry("https://health.clevelandclinic.org/hoovering",
                    "Pagina clinico-divulgativa consultata per l'uso corrente del termine e per la dichiarazione che non è un concetto clinico riconosciuto; non sostiene fattori, soglie o attribuzioni individuali."),
            entry("https://doi.org/10.3389/fpsyg.2021.662237",
                    "Studio di ricercatori di università italiane consultato per telefonate, messaggi, minacce e oggetti dopo una rottura recente; misura chi agisce, include eventi eterogenei e non valida l'hoovering ricevuto."),
            entry("https://doi.org/10.1080/08934215.2011.613737",
                    "Studio sulla persistenza dei tentativi di riconciliazione consultato per delimitare il riavvicinamento post-rottura; prospettiva di chi agisce e modello motivazionale non consentono inferenze sull'ex partner."),
            entry("https://doi.org/10.1891/0886-6708.15.1.73",
                    "Studio statunitense su contatti indesiderati dopo la rottura consultato per l'eterogeneità degli eventi; campione studentesco, strumento e costrutto non sono trasferiti all'app."),
            entry("https://doi.org/10.1177/0886260518822339",
                    "Studio nordamericano sulle intrusioni relazionali ripetute e indesiderate consultato per distinguere la persistenza da un singolo contatto; riguarda chi agisce e un fenomeno più ampio."),
            entry("https://doi.org/10.1177/15248380221090218",
                    "Scoping review consultata per contatti e abusi facilitati dalla tecnologia, inclusi canali e terze persone; studi e definizioni eterogenei non rendono ogni ricontatto una forma di abuso."),
            entry("https://www.istat.it/statistiche-per-temi/focus/violenza-sulle-donne/il-fenomeno/violenza-dentro-e-fuori-la-famiglia/il-numero-delle-vittime-e-le-forme-di-violenza/",
                    "Fonte istituzionale italiana consultata per distinguere stalking e violenza psicologica da una comune etichetta relazionale; dati sulle donne non sono soglie né valutazioni individuali."),
            entry("https://iris.unito.it/handle/2318/150383",
                    "Studio psicometrico su 896 partecipanti italiani consultato per la struttura multidimensionale dell'adattamento di coppia; la DAS, il campione e i suoi punteggi non validano le otto aree originali dell'app."),
            entry("https://www.minervamedica.it/it/riviste/minerva-psychiatry/articolo.php?cod=R17Y2002N02A0107",
                    "Precedente contributo italiano sulla Dyadic Adjustment Scale consultato per adattamento e misurazione diadica; item, norme e interpretazioni non vengono trasferiti."),
            entry("https://pubmed.ncbi.nlm.nih.gov/21280953/",
                    "Sviluppo della Relationship Quality Interview consultato per intimità emotiva e sessuale, sostegno, condivisione del potere e conflitto; intervista e coppie sposate statunitensi non validano il questionario."),
            entry("https://doi.org/10.1111/jomf.12804",
                    "Meta-analisi di 64 studi diadici consultata per comunicazione e limiti predittivi; gli effetti medi piccoli non permettono previsioni sulla singola coppia."),
            entry("https://doi.org/10.1177/02654075221128994",
                    "Meta-analisi consultata per congruenza, sostegno e conflitto tra obiettivi di coppia; associazioni di gruppo non definiscono valori corretti o compatibilità individuale."),
            entry("https://pmc.ncbi.nlm.nih.gov/articles/PMC9153093/",
                    "Meta-analisi consultata per qualità della comunicazione sessuale e soddisfazione; non implica attività sessuale, una frequenza ideale o causalità individuale."),
            entry("https://doi.org/10.1080/01926187.2025.2610780",
                    "Revisione sistematica di 29 studi consultata per fattori economici e soddisfazione relazionale; eterogeneità e recenza non definiscono soglie, causalità o consigli finanziari."),
            entry("https://doi.org/10.3390/ijerph182312717",
                    "Validazione italiana dell'EAPA-P consultata per il perimetro di pressione, manipolazione e controllo; strumento, fattori, item e punteggi non vengono trasferiti al questionario originale dell'app."),
            entry("https://eige.europa.eu/publications-resources/thesaurus/terms/1241?language_content_entity=en",
                    "Definizione europea consultata per pattern di coercizione, minacce, isolamento e umiliazione; non è una misura individuale né valida aree o soglie dell'app."),
            entry("https://www.who.int/health-topics/violence-against-women",
                    "Fonte istituzionale consultata per il quadro di danno psicologico, coercizione e comportamenti controllanti; riguarda soprattutto la violenza contro le donne e non classifica il singolo rapporto."),
            entry("https://doi.org/10.1371/journal.pone.0310297",
                    "Revisione sistematica COSMIN consultata per i limiti di validità di contenuto e criterio degli strumenti di screening della violenza di coppia; non valida il questionario dell'app."),
            entry("https://doi.org/10.1177/15248380231162972",
                    "Meta-analisi consultata per le associazioni tra controllo coercitivo, trauma e salute mentale; eterogeneità e disegni osservazionali non dimostrano causalità nel singolo caso."),
            entry("https://doi.org/10.1111/j.1741-3737.2007.00393.x",
                    "Meta-analisi consultata per l'associazione tra qualità relazionale e benessere personale; campioni soprattutto coniugati e dati correlazionali non consentono inferenze causali individuali."),
            entry("https://doi.org/10.1037/pas0000584",
                    "Sviluppo in cinque studi della PIES consultato per definizione, finestra dell'ultimo mese e struttura unidimensionale; item, proprietà e punteggi non vengono trasferiti."),
            entry("https://doi.org/10.1007/s12144-020-01238-6",
                    "Valutazione psicometrica portoghese consultata come evidenza europea della struttura unidimensionale; campione, lingua, item e punteggi non validano il questionario italiano dell'app."),
            entry("https://doi.org/10.1177/00332941241279372",
                    "Studio diadico portoghese consultato per associazioni tra invalidazione percepita, distress e soddisfazione; misura generale e disegno trasversale non consentono causalità o giudizi sulla singola relazione."),
            entry("https://doi.org/10.1080/10615806.2022.2033973",
                    "Studio con rilevazioni quotidiane consultato per associazioni preliminari con affetto e stress; campione piccolo e giovane e risultati attenuati in alcune analisi limitano il trasferimento."),
            entry("https://doi.org/10.1186/s40479-022-00185-x",
                    "Esperimento consultato per gli effetti di feedback validanti e invalidanti; la manipolazione breve e artificiale non rappresenta un pattern relazionale né definisce aree o soglie."),
            entry("https://doi.org/10.17632/gx6t7jhjtz.1",
